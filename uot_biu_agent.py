...
class UOT_BIU_Agent(IAgent.IAgent):
  def __init__(self, name="NATIV", learning_agent=False, shared_experience_replay=None):
  #####################################################
  ##################### CONFIG ########################
  #####################################################
    cfg = { 
    ...
    self.load_from = cfg.get('load_from','')
    self.load_policy()
  ...
  def load_policy(self):
    if self.load_from != '' and os.path.exists(self.load_from ): self.module.load_policy(self.load_from)
...
def run_agent_trainer():
    ...
    """Player Parameters"""
    agent1 = UOT_BIU_Agent("learning_agent1", True, shared_experience_replay)
    agent2 = UOT_BIU_Agent("learning_agent2", True, shared_experience_replay)
    agent3 = UOT_BIU_Agent("learning_agent3", True, shared_experience_replay)
    agent4 = UOT_BIU_Agent("learning_agent4", True, shared_experience_replay)
